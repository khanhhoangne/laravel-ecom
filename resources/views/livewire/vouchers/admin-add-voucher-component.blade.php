    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('vouchers')}}">Danh sách mã giảm giá</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row rowHeader">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('vouchers')}}" class="btn btn-primary btnRedirect">Tất cả mã giảm giá</a>
                            </div>
                        </div>
                        ...
                        <form class="row g-3" wire:submit.prevent="storeVoucher">
                            <div class="col-6">
                                ...
                                <input wire:model="voucher_code" type="text" class="form-control" placeholder="Nhập mã giảm giá">
                                @error('voucher_code') 
                            ...
                            <div class="col-6">
                                ...
                                <input wire:model="voucher_name" wire:keyup="generateSlug" type="text" class="form-control" placeholder="Nhập tên mã giảm giá">
                                @error('voucher_name') 
                                    <p class="text-danger" style="margin: 6px 0 0 0">{{$message}}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input wire:model="voucher_slug" type="text" class="form-control" placeholder="Liên kết tĩnh">
                                @error('voucher_slug') 
                                    <p class="text-danger" style="margin: 6px 0 0 0">{{$message}}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea wire:model="voucher_des" class="simpleTextArea" placeholder="Mô tả công dụng..."></textarea>
                                @error('voucher_des') 
                                    <p class="text-danger" style="margin: 6px 0 0 0">{{$message}}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <input wire:model="voucher_price" type="text" class="form-control" placeholder="Nhập giá trị">
                                @error('voucher_price') 
                                    <p class="text-danger" style="margin: 6px 0 0 0">{{$message}}</p>
                                @enderror
                            </div>
                            <div class="col-6">
                                ...
                                <input wire:model="voucher_max_uses" type="number" class="form-control" placeholder="Nhập giá trị">
                            ...
                            <div class="col-6">
                                ...
                                <input wire:model="voucher_max_uses_user" type="number" class="form-control" placeholder="Nhập giá trị">
                            ...
                            <div class="col-6">
                                ...
                                <input wire:model="voucher_date_begin" type="date" class="form-control" placeholder="Nhập giá trị">
                            ...
                            <div class="col-6">
                                ...
                                <input wire:model="voucher_date_end" type="date" class="form-control" placeholder="Nhập giá trị">
