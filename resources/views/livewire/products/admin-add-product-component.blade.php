    ...
    <section class="section">
        <div class="row">
            ...
            <div class="card">
                ...
                <!-- Vertical Form -->
                <form class="row g-3" wire:submit.prevent = "storeProduct">
                    <div class="col-6">
                    ...
                    <div class="col-12">
                        <div class="col-6">
                            <label for="image" class="form-label">Thư viện ảnh</label>
                            ...
                            @if(count($images))
                                ...
                                <div wire:loading wire:target="images">Đang tải...</div>
