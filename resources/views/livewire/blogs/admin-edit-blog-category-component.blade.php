        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <form class="row g-3" wire:submit.prevent = "updateCategory">
                    ...
                    <div class="col-6">
                        <label for="newBanner" class="form-label">Ảnh mô tả</label>
                        <input type="file" class="form-control" id="formFile"
                        wire:model="newBanner"
                        >

                        @if($newBanner)
                            <div wire:loading wire:target="newBanner">Đang tải...</div>
                            <img src="{{$newBanner->temporaryUrl()}}" width="120" style="margin: 6px 0 0 0"/>
                        @else
                            @if ($banner)
                            <img src="{{ asset('storage/uploads/blogcategories/'.$banner) }}" width="120" style="margin: 6px 0 0 0"/>
                            @endif
                    ...
                    <div class="text-center">
                        ...
                        <button class="btn btn-danger">
                            <a class="cancelColor" href="{{route('blogcategories')}}">Hủy bỏ</a>
                        </button>
                    </div>
                </form><!-- Vertical Form -->
