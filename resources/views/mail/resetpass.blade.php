			...
			<tr>
				<td>
					<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
						role="presentation"
						style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #091548; background-image: url('images/background_2.png'); background-position: center top; background-repeat: repeat;"
						width="100%">
						<tbody>
							<tr>
								<td>
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p
																			...
																			<span style="">Copyright © 2021 Your Brand,
																				All rights reserved.<br /><br />Where to
																				find us: 2047 Roosevelt Road</span></p>
																		<p
																			style="margin: 0; font-size: 12px; text-align: center;">
																			<span style=""><br />Changed your mind? You
																				can <a href="http://www.example.com"
																					rel="noopener"
